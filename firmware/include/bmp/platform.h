...
/* Common pins */
#define HWTYPE_PIN_0 (2) /* If 1 - MioLink or Pico/Pico W, if 0 - MioLink_Pico */

#define HWVERSION_PIN_0 (3)
#define HWVERSION_PIN_1 (4)

#define HWVERSION_PICO (0x03 + 1) /* All bits are 1 + 1 */

/* MioLink revA pins */
#define MIOLINK_REVA_TARGET_VOLTAGE_ADC_CHANNEL (3)
#define MIOLINK_REVA_TARGET_VOLTAGE_ENABLE_PIN  (16)
#define MIOLINK_REVA_TARGET_VOLTAGE_FAULT_PIN   (14)

#define MIOLINK_REVA_LED_ACT_PIN (17)
#define MIOLINK_REVA_LED_ERR_PIN (22)
#define MIOLINK_REVA_LED_SER_PIN (18)

#define MIOLINK_REVA_TARGET_TCK_PIN     (28)
#define MIOLINK_REVA_TARGET_TDO_PIN     (26)
#define MIOLINK_REVA_TARGET_TDI_PIN     (27)
#define MIOLINK_REVA_TARGET_TMS_PIN     (23)
#define MIOLINK_REVA_TARGET_TMS_DIR_PIN (24)

#define MIOLINK_REVA_TARGET_UART_TX_PIN (20)
#define MIOLINK_REVA_TARGET_UART_RX_PIN (25)

#define MIOLINK_REVA_TARGET_NRST_PIN (19)
